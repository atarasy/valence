...
**Open**: a remaining household's move verifies a departed giver's edge at the receiving host, which does not hold the key; retaining the key here does not help that move, and whether an export should carry the keys its edges need is a question for §14.2.
