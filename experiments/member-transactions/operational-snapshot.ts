...
export const operationalNamespaces = 'offers bare_receipts notes settlements settled_here provenance carried_payments member_statement_confirmations configs edges identities disclosures confirmations root_endorsed reservations mandates recoveries household_settled household_offers delivery permissions permission_actions permission_queries recoverers recovery_channels recovery_log deliberations registry_entries registry_keys writer_activation member_runtime'.split(' ');
