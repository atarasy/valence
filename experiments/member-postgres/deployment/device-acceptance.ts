...
try{
 ...
 // An allow-list of three classes, not a guess. Guessing from `code` hid every
 ...
 const ours=(error instanceof AcceptanceError||error instanceof ValenceError||error instanceof StoreError)&&typeof error.message==='string';
