...
// Production only, like review-invite.ts. The fallback for a proposal the reviewer's own signing did not present:
...
try{
 ...
 // The same allow-list as review-invite.ts: a driver error's text can hold a host or a role name.
